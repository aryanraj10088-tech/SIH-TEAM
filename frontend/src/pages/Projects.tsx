    ...
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage your content transformation workspaces</p>
        </div>
        <button 
      ...
      {projects.length === 0 ? (
        <div className="text-center p-12 border-2 border-dashed rounded-lg bg-gray-50">
          ...
          <p className="text-gray-500 mt-1">Get started by creating a new project workspace.</p>
        </div>
      ) : (
